class Player {
    ...
    incCurrentTime = () => {
        ...
        currentTime.innerHTML = `${this.currentMins}:${this.currentSeconds < 10 ? '0' + this.currentSeconds : this.currentSeconds}`
    ...
    displayTrackTime() {
        ...
        document.getElementById('track-time').innerHTML = `${mins}:${seconds < 10 ? '0' + seconds : seconds}`;
    }
